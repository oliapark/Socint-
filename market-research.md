...
3. **ניטור נרטיבים עוינים לארגונים יהודיים ופרו-ישראליים בחו"ל** (עודכן בפרק 10א: כשותף של SCN/CST/CyberWell, לא במכירה ישירה), בעברית, אנגלית וערבית. זה כיוון התרחבות שנותן גודל שוק.

**חו"ל (פרק 10א):** השוק הקרוב, חברות ישראליות שפועלות בחו"ל, מכפיל את ה-SOM לכ-$2-2.5M ARR. השוק הבינוני הכללי בחו"ל גדול, אבל שם יתרון השפה נעלם.

**שווקים כלליים (פרק 10ב):** ארה"ב (23/30) לפני אירופה (20), יפן (16) רק דרך שותף מקומי, וסין (10) לא.
...
## 10א. חו"ל: האם ההתרחבות מצילה את גודל השוק?

**השאלה:** בישראל ה-SOM הוא פחות ממיליון דולר ARR. האם חו"ל משנה את התמונה?
**התשובה הקצרה [פרשנות]:** רק חלקית. היתרון שלך (עברית, ערבית מקומית, הקשר ישראלי) שווה משהו בחו"ל רק בשווקים שקשורים לישראל או לקהילות יהודיות. בשוק הכללי בחו"ל היתרון הזה נעלם, ואת מתחרה ראש-בראש בכלים קיימים.

### 10א.1 ארבעה שווקים אפשריים בחו"ל

| שוק | מה ידוע [עובדה] | מי כבר שם | היתרון שלך | הערכה |
|---|---|---|---|---|
| **א. חברות ישראליות שפועלות בחו"ל** | [1,686 חברות טק ישראליות פועלות באירופה ומעסיקות 32,617 עובדים (ינואר 2025)](https://techtime.news/2025/12/23/kpmg-2/). ישראל [במקום האחרון במדד Nation Brands 2025](https://www.jpost.com/israel-news/article-881293), כולל בתדמית של מוצרי יצוא. [חברות מעבירות סחורה בלי שהיא עוברת בישראל כדי להקטין סיכון](https://www.calcalistech.com/ctechnews/article/bkmiufz5ge) | Cyabra ו-Blackbird (ארגונים גדולים), Brandwatch | **גבוה:** הבנה של הנרטיב נגד ישראל בכל השפות, קשר ישיר עם ההנהלה בישראל | ⭐ **הכי טוב** |
| **ב. ארגונים יהודיים בחו"ל** | ב-2025 [ביקשו מלכ"רים יותר מ-$1.3B מתוכנית NSGP, פי 5 מהתקציב](https://jewishinsider.com/2026/08/nonprofit-security-grant-program-2025-security-aid-fema/). [$94M הוענקו ל-512 ארגונים יהודיים](https://www.dhs.gov/news/2025/06/27/dhs-awards-94-million-grants-help-protect-512-jewish-faith-based-organizations) | **[SCN / Project RAIN](https://en.wikipedia.org/wiki/Secure_Community_Network)** מנטרת 12,400+ מוסדות בצפון אמריקה; **[CST](https://cst.org.uk/about-cst)** בבריטניה; **[ADL](https://www.adl.org/research-centers/center-technology-society)**; **[CyberWell](https://en.wikipedia.org/wiki/CyberWell)** (עמותה ישראלית, אנגלית וערבית, שותפה מהימנה של Meta וטיקטוק) | **בינוני:** ערבית ועברית, אבל הגופים המרכזיים כבר מספקים ניטור איומים לקהילה, כנראה בלי עלות למוסד הבודד | ⚠️ **ערוץ ולא שוק** |
| **ג. השוק הבינוני הכללי (אירופה וארה"ב)** | [79% מההנהלות נתקלו בדיסאינפורמציה ב-3 שנים, ורק ל-38% יש מנגנון תגובה](https://www.weforum.org/stories/2025/07/financial-impact-of-disinformation-on-corporations/). WEF מעריך את עלות הדיסאינפורמציה לעסקים בכ-$78B בשנה | [Visibrain (צרפת) מ-€800 לחודש](https://www.visibrain.com/tarifs), Brand24, Talkwalker, Meltwater, [Storyzy](https://www.cbinsights.com/company/storyzy) | **נמוך:** אין יתרון שפה, ואת מתחרה במחיר ובמותג | ❌ לא בשלב הזה |
| **ד. שוק ערבי ומפרץ** | Lucidya [$30M ב-2025](https://www.middleeastainews.com/p/lucidya-biggest-saudi-ai-funding), Crowd Analyzer ב-13+ ניבים | Lucidya, Crowd Analyzer, Aim Technologies | **נמוך-שלילי [פרשנות]:** חברה ישראלית שמוכרת מודיעין רשתות במפרץ נתקלת בחסמים פוליטיים ורגולטוריים | ❌ |

**סתירה או הסתייגות:** נתוני 79%/38% ו-$78B מגיעים ממחקר WEF שמצטט מחקר מ-2019 (Cavazos/CHEQ). הם לא נמדדו על ארגונים בינוניים דווקא.
**לא אומת:** האם אפשר לממן מנוי ניטור מקוון מכספי NSGP. [ההוצאות המותרות](https://www.fema.gov/grants/preparedness/nonprofit-security) מתמקדות בציוד, אבטחה פיזית, תכנון והדרכה. אם מנוי כזה מותר, זה משנה את התמונה לשוק ב'. שווה לבדוק מול יועץ מענקים.

### 10א.2 גודל השוק בחו"ל [הערכה: כל הקלטים הם הנחות]
| שוק | לקוחות פוטנציאליים | מחיר לשנה | TAM | SAM | SOM (3 שנים) |
|---|---|---|---|---|---|
| א. חברות ישראליות בחו"ל | ~3,000 (1,686 באירופה [עובדה] + ארה"ב ומותגי צריכה [הערכה]) | $30K | $90M | 20% → $18M | 5% → **$0.9M** |
| ב. ארגונים יהודיים (ישירות) | ~1,500 פדרציות, ארגונים ארציים ומוסדות גדולים | $15K | $22.5M | 40% → $9M | 5% → **$0.45M** |
| ב'. ארגונים יהודיים (דרך SCN/CST כשותף) | 1-3 חוזים | $100-300K | – | – | **$0.1-0.9M** |

**[פרשנות] המסקנה:** ישראל ביחד עם חו"ל (א+ב) נותנות SOM של בערך **$2-2.5M ARR**, פי 2.5 מישראל לבד. זה עסק שירות רווחי עם 10-20 עובדים, ועדיין לא חברה שנבנית לגיוס VC. כדי להגיע לסדר גודל של VC צריך לעבור לשוק ג' (הכללי), ושם הבידול היחיד שנשאר הוא מודל השירות של AI ואנליסט, לא השפה.

### 10א.3 שיקולים מעשיים לחו"ל
- **משפטי:** מכירה ללקוחות באירופה מחילה GDPR במלואו. [חוות דעת EDPB 28/2024](https://www.edpb.europa.eu/system/files/2024-12/edpb_opinion_202428_ai-models_en.pdf) משאירה פתח לאינטרס לגיטימי, אבל [הרשות ההולנדית מחמירה](https://www.hoganlovells.com/en/publications/dutch-dpa-issues-guidelines-on-data-scraping_1). צריך DPIA ונציג באיחוד האירופי. בארה"ב הסיכון נמוך יותר (ראו פרק 8.1).
- **תדמית:** "חברה ישראלית שמנטרת שיח" באירופה או במפרץ עלולה להפוך בעצמה לנושא של נרטיב עוין. צריך מדיניות אתית מפורסמת ושקיפות לגבי לקוחות.
- **שפות:** בשוק א' צריך לפחות אנגלית, ערבית, צרפתית וגרמנית (לפי המרכזים של חברות ישראליות באירופה: [גרמניה, ספרד, צרפת](https://www.ynetnews.com/tech-and-digital/article/bk2c9rymzx)). AI מקטין את הפער, אבל אנליסט עם הבנת הקשר חייב לדבר בשפה.
- **ערוצי הפצה:** לשכות מסחר (ישראל-גרמניה, ישראל-צרפת), אגפי יצוא ומכון היצוא, קרנות הון סיכון עם חברות בפורטפוליו, ומשרדי עורכי דין בינלאומיים.

### 10א.4 עדכון להמלצות
1. **נישה 1 מורחבת:** "חברות ישראליות בבית ובחו"ל" היא אותה נישה ואותו ICP. להתחיל בישראל, ולהוסיף מעקב אחרי השוק הזר של כל לקוח (תוספת של $1-2K לחודש לכל שוק).
2. **נישה 3 משתנה:** לא למכור ישירות למוסדות יהודיים, אלא **לפנות ל-SCN, ל-CST או ל-CyberWell כשותף או ספק משנה** לניתוח נרטיבים בערבית ובעברית. אלה לקוחות מעטים וגדולים ולא הרבה קטנים.
3. **שוק כללי בחו"ל:** לדחות לשלב שאחרי 15-20 לקוחות. אז לבדוק אם מודל השירות לבדו מחזיק בלי יתרון השפה.

**שאלות נוספות לראיונות (לחו"ל):**
- (לחברות ישראליות בחו"ל) האם המקור הישראלי שלכם עלה בשיח ברשת בשווקים שלכם? מתי ואיך גיליתם?
- מי אחראי אצלכם על תדמית בכל שוק: ההנהלה בישראל, מנהל מקומי, או סוכנות מקומית?
- (לארגונים יהודיים) מה אתם מקבלים היום מ-SCN, CST או הפדרציה, ומה חסר לכם?

---

## 10ב. שווקים כלליים: ארה"ב, אירופה, יפן וסין

**השאלה:** מה אם יוצאים לשוק הכללי, בלי זיקה לישראל? את מי כדאי לבדוק, ובאיזה סדר?
**התשובה הקצרה [פרשנות]:** **ארה"ב** היא השוק הכללי הכי מתאים לכניסה ראשונה. **אירופה** אפשרית בנישת שפות שיש לך בהן יתרון. **יפן** רק דרך שותף מקומי. **סין** לא.

### 10ב.1 השוואה בין השווקים

| | 🇺🇸 ארה"ב | 🇪🇺 אירופה | 🇯🇵 יפן | 🇨🇳 סין |
|---|---|---|---|---|
| **גודל שוק ה-listening** | הגדול בעולם: [39.9% מהשוק](https://www.grandviewresearch.com/industry-analysis/social-media-listening-market-report), כלומר ~$4-4.8B [הערכה: 39.9% × $10.4-12.2B] | [27.4%](https://www.coherentmarketinsights.com/industry-reports/social-media-listening-market), ~$2.8-3.3B [הערכה] | חלק מאסיה-פסיפיק, [25.1%, האזור שצומח הכי מהר](https://www.coherentmarketinsights.com/industry-reports/social-media-listening-market). לא נמצא נתון ליפן לבד | שוק "ניטור דעת קהל" (yuqing) נפרד: [$1.5B ב-2024 → $3.0B ב-2033](https://www.verifiedmarketreports.com/product/public-opinion-monitoring-system-market/) |
| **פלטפורמות** | FB, IG, TikTok, X, Reddit. כולן נגישות דרך ספקי צד-שלישי | כמו ארה"ב, ועוד פורומים מקומיים | [X הוא השוק השני בגודלו של X בעולם (~70M משתמשים)](https://tam-tamlo.com/en/285), [LINE (96M) סגור](https://www.humblebunny.com/japan-top-social-media-networks/), ו-5ch | [Weibo, Douyin, Xiaohongshu, WeChat](https://www.largitdata.com/en/knowledge/china-social-media-data/). אקוסיסטם סגור, וזרים מקבלים את הנתונים רק דרך ספקים סיניים |
| **תלות בפלטפורמות סגורות** | בינונית | בינונית | **גבוהה:** X הוא הערוץ המרכזי, וה-API שלו יקר ומוגבל ל[3M קריאות בחודש](https://docs.x.com/x-api/getting-started/pricing) | **מוחלטת** |
| **רגולציה** | **הכי מקלה:** פסקי הדין נגד Meta ו-X ([8.1](#81-מעמד-ה-scraping-ארהב-עובדה)); [24 חוקי פרטיות מדינתיים](https://www.privacyworld.blog/2026/08/adding-to-the-count-the-latest-in-state-consumer-privacy-laws/), רובם עם חריג למידע ציבורי ש[מתחיל להצטמצם (קונטיקט 2026)](https://oaklandprivacy.org/wp-content/uploads/2026/05/pai-brief-1.pdf) | **מחמירה:** GDPR, [הרשות ההולנדית](https://www.hoganlovells.com/en/publications/dutch-dpa-issues-guidelines-on-data-scraping_1), DSA. [גישה לנתוני מחקר לפי סעיף 40 מוגבלת לחוקרים בלי אינטרס מסחרי](https://www.hlc.com/en/publications/who-gets-to-see-inside-the-eus-new-rules-on-data-access-under-article-40-of-the-dsa) | בינונית: לפי [APPI](https://www.dlapiperdataprotection.com/index.html?t=law&c=JP), גם מידע שפורסם ברשת נחשב מידע אישי, ויש חובת שקיפות לגבי מטרת האיסוף. [תיקונים ב-2026](https://www.morihamada.com/en/insights/newsletters/138006) | **חוסמת:** PIPL, DSL, [חובת נציג מקומי ואחסון נתונים בסין](https://appinchina.co/blog/the-complete-guide-to-social-listening-in-china/) |
| **מתחרים בנישת הנרטיב לארגונים בינוניים** | צפוף: Blackbird, Alethea, [PeakMetrics ($6M Series A)](https://www.axios.com/2026/04/09/peakmetrics-funding-ai-reputation-risk), [Pendulum](https://techcrunch.com/2022/01/07/pendulum-raises-5-9m-to-help-organizations-track-harmful-narratives/), [Zignal (נקנתה על ידי ICE)](https://www.trysignalbase.com/news/acquisitions/zignal-labs-acquired-by-ice-acquisition) | [Visibrain (מ-€800 לחודש)](https://www.visibrain.com/tarifs), [Storyzy](https://www.cbinsights.com/company/storyzy), Talkwalker, Brandwatch | **[Adish](https://nz.finance.yahoo.com/quote/7093.T/profile/)**: ניטור 24/7 כשירות מנוהל, בדיוק המודל שלך. [Eltes ($59.8M הכנסות)](https://getlatka.com/companies/eltes/vs/glimpse-group-llc), [Hottolink](https://e27.co/startups/hottolink/) | [Gsdata, Sina/Weibo, Baidu ואחרים; כ-2 מיליון אנליסטים](https://www.verifiedmarketreports.com/product/public-opinion-monitoring-system-market/) |
| **כאב** | גבוה: אקטיביזם, חרמות, קיטוב פוליטי | גבוה: [500+ אירועי מניפולציה והתערבות זרה ב-2024](https://digital-strategy.ec.europa.eu/en/funding/detecting-influence-campaigns-and-boosting-societal-resilience) | **גבוה מאוד:** ["enjo" (הסתערות רשת)](https://www.sciencedirect.com/science/article/abs/pii/S1567422316300072) גורם לסגירת עסקים ולפגיעה בשווי | גבוה, אבל משרת בעיקר את הממשל |
| **חסמי כניסה לחברה ישראלית** | נמוכים | בינוניים (GDPR, שפות) | **גבוהים:** [78% מהקונים הארגוניים לא ישקלו ספק בלי תמיכה ביפנית](https://nihonium.io/language-barriers-japan-saas-entry/) | **כמעט בלתי עבירים** |

**הסתייגויות:** ה-78% ביפן מגיעים מבלוג של חברת ייעוץ לכניסה לשוק היפני, שיש לה אינטרס. נתוני ה-yuqing בסין מגיעים ממקורות מחקר-שוק לא מבוססים. [PeakMetrics מופיעה עם סך גיוסים של $12.7M או $16.3M, תלוי במקור](https://www.cbinsights.com/company/peakmetrics/financials).

### 10ב.2 ניקוד [הערכה] (1-5, 5 = הכי טוב בשבילך)
| קריטריון | ארה"ב | אירופה | יפן | סין |
|---|---|---|---|---|
| גודל שוק | 5 | 4 | 3 | 3 |
| כאב | 4 | 4 | 5 | 3 |
| תחרות (5 = נמוכה) | 2 | 3 | 2 | 1 |
| רגולציה (5 = מקלה) | 4 | 2 | 3 | 1 |
| גישה לנתונים | 4 | 4 | 2 | 1 |
| קלות כניסה (שפה, תרבות, ערוצים) | 4 | 3 | 1 | 1 |
| **סה"כ (מתוך 30)** | **23** | **20** | **16** | **10** |

### 10ב.3 מה זה אומר לכל שוק [פרשנות]

**🇺🇸 ארה"ב: השוק הכללי הראשון, עם בידול שירותי.**
- **הסימן החשוב:** [FGS Global, חברת יח"צ ענקית, קנתה את Memetica](https://fgsglobal.com/insights/fgs-global-launches-ai-advisory-practice-and-acquires-threat-intelligence-firm-memetica) (ינואר 2026), חברת מודיעין איומים. זה מאשר שסוכנויות יח"צ רוצות מודיעין נרטיב אצלן בבית. הסוכנויות הבינוניות שלא יכולות לקנות חברה הן קהל היעד של נישה 2 בגרסה האמריקאית.
- **הבידול:** לא שפה, אלא "חדר ניטור נרטיבים מנוהל" עם אנליסט, לסוכנויות ולחברות בינוניות, במחיר שבין Brand24 ל-Blackbird.
- **מגבלה:** צריך נוכחות מכירתית בארה"ב (שעות עבודה, פגישות), ואסור להיכנס לנישה הפוליטית.
- **גודל נישה אפשרי [הערכה]:** 50 לקוחות × $30K = $1.5M ARR אחרי 3 שנים. זה לבד כבר יותר מכל השוק הישראלי.

**🇪🇺 אירופה: נישת שפות.**
- **הזדמנות [פרשנות]:** שיח בערבית בצרפת, בגרמניה ובבלגיה (קהילות מהגרים, נרטיבים על המזרח התיכון) הוא נקודה עיוורת לכלים המקומיים ולענקיות. **הערבית שלך רלוונטית גם כאן, בלי קשר לישראל.** לקוחות אפשריים: רשויות מקומיות, מותגים, תחבורה, ספורט.
- **חסמים:** GDPR מחמיר, צריך DPIA ונציג באיחוד, ו"חברה ישראלית שמנטרת שיח בערבית באירופה" רגיש במיוחד מבחינה תדמיתית.
- **מתחרה מקומי חזק:** Visibrain בצרפת, כבר עם לקוחות כמו [SNCF](https://www.visibrain.com/clients/sncf).

**🇯🇵 יפן: הכאב הכי חזק, הכניסה הכי קשה.**
- תרבות ה-"enjo" יוצרת ביקוש אמיתי, ו-Adish כבר מוכיחה שיש שוק לשירות ניטור מנוהל.
- אבל בלי יפנית, בלי אנליסטים יפנים ובלי שותף מקומי אין כניסה. גם התלות ב-X גבוהה, והנתונים שלו יקרים ומוגבלים.
- **אם בכלל:** להציע טכנולוגיה (שכבת AI לניתוח נרטיב) לשותף מקומי כמו Adish או Hottolink, ולא להיכנס בעצמך.

**🇨🇳 סין: לא.**
- אקוסיסטם נתונים סגור, חובת נציג ואחסון מקומיים, מעורבות ממשלתית עמוקה, ושוק שנשלט על ידי שחקנים סיניים. חברה ישראלית קטנה לא יכולה להתחרות שם, והסיכון המשפטי והתדמיתי גבוה.

### 10ב.4 סדר מומלץ [פרשנות]
```
שלב 1: ישראל (נישות 1+2)            → מקרי בוחן, תהליך, תמחור
שלב 2: חברות ישראליות בחו"ל (10א)    → אותו לקוח, שווקים חדשים
שלב 3: ארה"ב, סוכנויות יח"צ בינוניות → בידול שירותי, בלי תלות בשפה
שלב 4: אירופה, שיח בערבית           → אחרי DPIA ונציג באיחוד
יפן: רק כשותף טכנולוגי             | סין: לא
```

**מה צריך לבדוק לפני שלב 3:**
- האם סוכנויות יח"צ אמריקאיות בינוניות מוכנות לקנות מספק זר? שווה לעשות 5 ראיונות.
- מה המחירים של PeakMetrics ו-Pendulum. הם לא מפורסמים, ואפשר לבקש הדגמה.
- האם יש ביקוש לשיח בערבית באירופה: לראיין 3-5 מנהלי תקשורת ברשויות ובמותגים בצרפת או בגרמניה.
